...
# else:		# selected_region == 'US'
# 	const type = 'deaths' if selected_data == 'Reported Deaths' else 'cases'
# 	const url = 'https:# raw.githubusercontent.com/nytimes/covid-19-data/master/us-states.csv'
# 	Plotly.d3.csv(url, (data) => this.processData(this.preprocessNYTData(data, type), selected_region, update_selected_countries))
